...
drying rate, and the full force balance at the three-phase contact line, including solid–vapour, solid–liquid, and
liquid–vapour surface tension components. For water droplets on glass, evaporation proceeds primarily in the
Constant Contact Radius (CCR) mode with a nearly constant drying rate, while oil-coated substrates exhibit
Constant Contact Angle (CCA) behavior with a rapidly decaying rate. Temperature elevation from 30 ◦C to 45 ◦C
accelerates evaporation by ≈ 40% and shifts the CCR-to-CCA transition earlier. Ethanol droplets confirm the same
...
- Popov Diffusion-Limited Evaporation Model
- Picknett–Bexon Evaporation Model
...
- Numerical calculation of instantaneous evaporation rate (|dV/dt|)
- Comparison of CCR and CCA evaporation modes

## Key Results
1. Water droplets on glass exhibited Constant Contact Radius (CCR) evaporation, while oil-coated substrates showed Constant Contact Angle (CCA) behavior.
2. Increasing the temperature from 30°C to 45°C reduced drying time by approximately 43% for both water and ethanol.
3. Ethanol evaporated approximately 2.5× faster than water because of its higher vapor pressure and diffusivity.
4. Oil-coated surfaces produced 8–10× higher initial evaporation rates owing to larger contact angles and enhanced geometric factors.
5. Experimental observations closely matched diffusion-limited evaporation theory and Popov's geometric correction model.
...
* 📊 **Project Presentation:** [View slides](https://canva.link/0q0s1ks9t1pfgok)
